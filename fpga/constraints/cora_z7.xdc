...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { sys_clk_pin }];#set
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_0_35 Sch=led1_b
